...
class Test32ReplyaPostPositiveResult():
  ...
  def test_32ReplyaPostPositiveResult(self):
    ...
    time.sleep(5)
    self.driver.find_element(By.CSS_SELECTOR, ".css-175oi2r:nth-child(1) > .css-175oi2r:nth-child(2) > .css-146c3p1 > .css-1jxf684 > .css-1jxf684").click()
