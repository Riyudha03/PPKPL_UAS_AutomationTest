...
class Test51PasswordChangeNegativeResult():
  ...
  def test_51PasswordChangeNegativeResult(self):
    self.driver.get("https://x.com/home")
    self.driver.set_window_size(652, 726)
    time.sleep(5)
    self.driver.find_element(By.CSS_SELECTOR, ".r-6koalj:nth-child(8) > .css-175oi2r").click()
    ...
    self.driver.find_element(By.NAME, "current_password").send_keys(" V33j@dMK$")
    self.driver.find_element(By.NAME, "new_password").click()
    self.driver.find_element(By.NAME, "new_password").send_keys("v33j@s11")
    self.driver.find_element(By.NAME, "password_confirmation").click()
    self.driver.find_element(By.NAME, "password_confirmation").send_keys("v337@$16")
